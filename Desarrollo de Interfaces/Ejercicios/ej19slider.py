from PyQt6.QtWidgets import QApplication, QMainWindow, QSlider# Se importa solo lo que necesitas
...
class MainWindow(QMainWindow):
    def __init__(self): # Esto es una función a la que le pasas "self" que es la propia clase ¿constructor?
        ...
        slider.valueChanged.connect(self.cambio)
        slider.sliderMoved.connect(self.cambio)
