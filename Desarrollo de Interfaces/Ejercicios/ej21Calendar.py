from PyQt6.QtWidgets import QApplication, QMainWindow, QCalendarWidget# Se importa solo lo que necesitas
...
class MainWindow(QMainWindow):
    def __init__(self): # Esto es una función a la que le pasas "self" que es la propia clase ¿constructor?
        ...
        self.calendar.selectionChanged.connect(self.cambio)
